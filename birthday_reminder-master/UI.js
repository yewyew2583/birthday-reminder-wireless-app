	...
	render() {
		return (
			<View style={[inputStyles.container, { flexDirection: this.orientation }]}>
				...
				<MKTextField
					tintColor={this.props.tintColor ? this.props.tintColor : MKColor.Lime}
					highlightColor={this.props.highlightColor ? this.props.highlightColor : blue}
					textInputStyle={this.props.textInputStyle ? this.props.textInputStyle : { color: MKColor.Orange }}
